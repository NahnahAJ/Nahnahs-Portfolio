  ...
  const projects = [
    {
      ...
      image: 'https://res.cloudinary.com/db3ckadxp/image/upload/v1679235534/work1_vktdop.png',
      description:
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/db3ckadxp/image/upload/v1679244665/Screenshot_from_2023-03-19_16-50-48_nwe23k.png',
      description: 'The project is based on an app to book an appointment with a health specialist(Doctor). The doctor appointment booking app permits healthcare providers to manage their appointments with increased efficiency while giving reliable management. However, it displays all details of the patients, complete history of appointment, analyses the doctors, etc',
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/db3ckadxp/image/upload/v1679235584/work2_oydama.png',
      description:
    ...
    },
    {
      ...
      technologies: "HTML5, CSS3, Javascript, Webpack",
      image: 'https://res.cloudinary.com/db3ckadxp/image/upload/v1679235608/work3_lmizxf.png',
      description:
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/db3ckadxp/image/upload/v1679235660/work5_mmmdgs.png',
      description:
    ...
    },
    {
      ...
      technologies: 'React, Redux, Javascript, HTML/CSS',
      image: 'https://res.cloudinary.com/db3ckadxp/image/upload/v1679235669/work6_tpynfq.png',
      description:
  ...
  <span class="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">
    Projects
      ...
      {projects.map((project) => (
        <div href="#" className="flex flex-col items-center w-full bg-white border border-gray-200 pb-4 mb-6 rounded-lg shadow-md md:flex-row justify-around hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
    <img className="object-cover w-full rounded-t-lg h-64 md:h-auto md:w-64 md:rounded-none md:rounded-r-lg" src={project.image} alt="" />
    <div className="flex flex-col justify-between p-4 leading-normal md:text-left w-full md:w-auto">
      <h2 className="font-bold text-2xl text-gray-900">{project.name}</h2>
      <span className="text-indigo-500 flex flex-wrap mt-2">
        {/* Project languages */}
        {project.technologies && project.technologies.split(',').map((language, index) => (
          <span key={index} className="inline-block bg-indigo-100 text-indigo-500 rounded-full px-3 py-1 text-sm font-semibold mr-2 mb-2 justify-center">
            {language}
          </span>
        ))}
      </span>
